...
app.lang['es'] = (function() {
	...
	return {
		...
		'payment-request.crypto-amount.field-missing': 'No se puede convertir a la cantidad de criptodivisa sin "{{field}}"',
		'payment-request.crypto-amount.unknown-method': 'No se puede convertir a la cantidad de criptodivisa debido a que el método de pago no existe',
